...
import pt.ipt.dam2025.vetconnect.databinding.FragmentAgendarVacinaBinding // Importa a classe de ViewBinding gerada
...
class AgendarVacinaFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        observeLists()
        // Começa a observar o estado da operação de agendamento
        observeViewModel()
    }
    ...
    private fun setupListeners() {
        ...
        // Chama a função para agendar a vacina quando o botão de confirmar é clicado
    ...
    private fun observeLists() {
        ...
        viewModel.tiposVacina.observe(viewLifecycleOwner) { tipos ->
            ...
            // Cria um adapter com os nomes dos tipos de vacina e define-o no spinner
    ...
    /**
     * Recolhe todos os dados do formulário valida-os e chama o ViewModel para agendar a vacina
     */
    private fun agendarVacina() {
        ...
        // Cria o objeto de pedido para enviar à API
        val request = AgendarVacinaRequest(animalId, tipoVacinaId, clinicaId, veterinarioId, apiDate, observacoes)
        // Chama a função do ViewModel para agendar a vacina
        viewModel.agendarVacina(token, request)
    }

    /**
     * Observa o estado da operação de agendar a vacina
